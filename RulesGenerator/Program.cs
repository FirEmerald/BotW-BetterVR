...
Rules rules = new Rules("Better VR", "\"The Legend of Zelda: Breath of the Wild/Better VR\"", "Used to enable BetterVR.||||Most settings will be found inside the in-game menu by long pressing the mod menu button (X on Touch/Left A on Index).||Made by Crementif.", true)
